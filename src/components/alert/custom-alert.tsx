...
import { FlexOne, FlexRow } from '../basic-elements/index';

export interface ICustomAlertShow {
	id?: string;
	title: string;
	subtitle?: string;
...
function _CustomAlert(props: ICustomAlertShow) {
...
export const CustomAlert = memo(_CustomAlert);
